...
exports.DEFAULT_BASE_API_URL = "https://api.together.xyz/v1/images/generations";
class ImageGenPlugin {
    constructor(options) {
        ...
        this.apiKey = options.apiClientConfig.apiKey || exports.DEFAULT_API_KEY;
        this.baseApiUrl = options.apiClientConfig.baseApiUrl || exports.DEFAULT_BASE_API_URL;
    }
    getWorker(data) {
        return new game_1.GameWorker({
            ...
            functions: (data === null || data === void 0 ? void 0 : data.functions) || [this.generateImage],
        ...
        return new game_1.GameFunction({
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    if (!args.prompt) {
                        return new game_1.ExecutableGameFunctionResponse(game_1.ExecutableGameFunctionStatus.Failed, "Prompt is required for image generation");
                    }
...
exports.default = ImageGenPlugin;
