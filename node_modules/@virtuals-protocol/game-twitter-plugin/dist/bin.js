...
var getLoginUrl = (apiKey) => __async(exports, null, function* () {
...
var verify = (code, state) => __async(exports, null, function* () {
...
program.name("game-twitter-plugin").description("CLI to authenticate and interact with GAME's Twitter API").version("0.1.0");
program.command("auth").description("Authenticate with Twitter API").option("-k, --key <char>", "project's API key").action((options) => {
  const apiKey = options.key;
  if (!apiKey) {
    console.error("API key is required!");
    return;
  }
  const server = import_http3.default.createServer((req, res) => __async(exports, null, function* () {
    var _a;
  ...
  server.listen(8714, () => __async(exports, null, function* () {
